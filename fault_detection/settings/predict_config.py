...
class AnomalyDetectorPredictConfig:
    def __init__(self, data_config:DataConfig):
        ...
        """
        from fault_detection.settings.manager import get_selected_model_path, load_log_config
...
if __name__ == "__main__":
    from manager import SelectFaultDetectionModel
