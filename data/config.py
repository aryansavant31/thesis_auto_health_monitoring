...
class DataConfig:
    def __init__(self, run_type='train', view_dataset=False):
        ...
        self.signal_types = NXEGroupMaker().ws_ls1_pos
    ...
    def set_train_dataset(self):
        ...
        self.unhealthy_configs = {
            ...
            key : value for key, value in zip(e1_keys_nok, f.ws_ls1_pos_faults(level=2))
    ...
    def set_custom_test_dataset(self):
        ...
        self.unhealthy_configs = {
            key : value for key, value in zip(e1_keys_nok, f.ws_ls1_pos_faults(level=6))
