function conn = config_machine_param(conn)
    ...
    conn.mass(10) = 0.0001;
    conn.mass(11) = 0.0001;
    conn.mass(12) = 0.000108;
    
    %% Spring/dampers between masses

    % configure linear spring
    conn.spring_k(1) = 0.502;
    conn.spring_k(2) = 0.5;
    conn.spring_k(3) = 0.5;
    conn.spring_k(4) = 0.5;
    conn.spring_k(5) = 0.504;
    conn.spring_k(6) = 0.5;
    conn.spring_k(7) = 0.496;
    conn.spring_k(8) = 0.508;
    conn.spring_k(9) = 0.5;
    ...
    conn.damper_d(1) = 0.5;
    conn.damper_d(2) = 0.5;
    conn.damper_d(3) = 0.509;
    conn.damper_d(4) = 0.5;
    conn.damper_d(5) = 0.498;
    conn.damper_d(6) = 0.5;
    conn.damper_d(7) = 0.5;
    conn.damper_d(8) = 0.504;
    conn.damper_d(9) = 0.5;
