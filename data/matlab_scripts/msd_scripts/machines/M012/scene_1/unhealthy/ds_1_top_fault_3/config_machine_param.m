function conn = config_machine_param(conn)
    ...
    conn.spring_k(2) = 0.5;
    conn.spring_k(3) = 0.5;
    conn.spring_k(4) = 0.51;
    conn.spring_k(5) = 0.5;
    conn.spring_k(6) = 0.509;
    conn.spring_k(7) = 0.5;
    conn.spring_k(8) = 0.5;
    conn.spring_k(9) = 0.49;
    conn.spring_k(10) = 0.5;
    
    
    % configure linear damper
    conn.damper_d(1) = 0.51;
    conn.damper_d(2) = 0.5;
    conn.damper_d(3) = 0.5;
    conn.damper_d(4) = 0.5;
    conn.damper_d(5) = 0.505;
    conn.damper_d(6) = 0.5;
    conn.damper_d(7) = 0.5;
    conn.damper_d(8) = 0.495;
    conn.damper_d(9) = 0.5;
    conn.damper_d(10) = 0.5;
